...
(function () {
  ...
  function buildPrompt(headings) {
    ...
    return [
      ...
      '- Multiple H1 headings: if more than one non-sr-only H1 appears, flag each one after the first. Use headingIndex of the duplicate H1.',
      '- Empty or meaningless heading text (e.g. "(empty)", single punctuation, generic filler).',
      '- Vague text that does not describe section content (e.g. "Click here", "More", "Read more", "Latest", "Featured", "Other").',
